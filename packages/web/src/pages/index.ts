...
export { default as Domains } from '../pages/AdminPanel/Domains/Domains';
export { default as AddDomain } from '../pages/AdminPanel/Domains/AddDomain';
export { default as UpdateDomain } from '../pages/AdminPanel/Domains/UpdateDomain';

export { default as Users } from '../pages/AdminPanel/Users/Users';
export { default as AddUser } from '../pages/AdminPanel/Users/AddUser';
export { default as UpdateUser } from '../pages/AdminPanel/Users/UpdateUser';

export { default as Orders } from '../pages/AdminPanel/Orders/Orders';
export { default as OrderView } from '../pages/AdminPanel/Orders/OrderView';
export { default as AddOrder } from '../pages/AdminPanel/Orders/AddOrder';
export { default as UpdateOrder } from '../pages/AdminPanel/Orders/UpdateOrder';
...
export { default as CompanyOrders } from '../pages/CompanyOrders/CompanyOrders';
export { default as CompanyOrderView } from '../pages/CompanyOrders/CompanyOrderView';
